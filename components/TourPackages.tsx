...
const destinations = [
  ...
  },
  {
    ...
    description:
      "Discover our available China tour packages and exciting destinations.",
    icon: "🇨🇳",
    href: "/china-uos",
  },
  {
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-10">
          ...
          <p className="mt-3 max-w-2xl mx-auto text-gray-500">
            Discover our latest tour packages and choose your next adventure.
          </p>
        </div>
        ...
        <div className="text-center mt-8">
          <p className="text-sm text-gray-400">
            More destinations and tour packages coming soon.
          </p>
        </div>

...
export default function FlightPage() {
  ...
  const inputStyle =
    "w-full p-4 rounded-xl border border-gray-300 text-black placeholder:text-gray-500 focus:outline-none focus:border-red-600";
...

            {
              [
                ...
                <button
                  ...
                  className={`
                    px-6 py-3 rounded-full border font-medium
                    ${
                      tripType === type
